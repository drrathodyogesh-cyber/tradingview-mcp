...
Write-Host "    OK - laptop stays awake when lid closes" -ForegroundColor Green
...
Write-Host "Log: C:\Users\drrat\tradingview-mcp\execution_lane\logs\scheduler_run.log"
Write-Host ""
